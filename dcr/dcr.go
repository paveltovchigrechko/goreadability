...
const (
	diffWordsThreshold = 5.0
	adjustedScore      = 3.6365
)
...
// countDiffWords accepts a string and returns the number of difficult words in it.
// A word is counted as a difficult if it isn't in `easyWords` map.
func countDiffWords(s string) int {
